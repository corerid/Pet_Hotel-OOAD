...
import static pethotel.ShowCustomerListController.customerNameFromshowmore;
import static pethotel.ShowCustomerListController.primaryKeyFromshowmore;
 ...
 if (event.getClickCount() == 2) //Checking double click
        {
            ...
            String usernameSelect = table.getSelectionModel().getSelectedItem().getUsername();
            System.out.println(usernameSelect);
            if(usernameSelect.contains("admin")){
                ...
                Query q10 = em.createQuery("DELETE FROM Staff s WHERE s.Username =: user");
                q10.setParameter("user", usernameSelect).executeUpdate();
